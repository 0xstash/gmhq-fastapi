...
finance_tool = FMPClient(api_key=os.getenv("FMP_API_KEY"))
...
agent = Agent(tools=[finance_tool, DateTimeTool()])
agent.run(
    """
how much did the cash reserves of intel grow in the last 2 years? Give me the exact figures for last 2 years too"""
)
