...
class ArtifactGenerationTool(BaseTool):
    ...
    # Required fields
    prompt_driver: Optional[BasePromptDriver] = field(kw_only=True, default=None)
    ...
    def _validate_identifier(self, identifier: str) -> bool:
        """Validate identifier format allowing both hyphens and underscores"""
    ...
    def generate_artifact(
        ...
        try:
            ...
            if not self._validate_identifier(identifier):
                raise ArtifactError(
                    "Identifier must contain only alphanumeric characters, hyphens, or underscores"
                )
    ...
    def _generate_text_artifact(self, values: dict) -> TextArtifact:
        ...
        try:
            ...
            # Use the prompt directly as content since we don't need the prompt_driver
            ...
            marked_output = (
                f"Here's what I've created:\n\n"
                "[ARTIFACT_START]\n"
                f"{artifact_xml}\n"
                "[ARTIFACT_END]\n\n"
                "I can explain how this works or make any modifications you need."
            )
